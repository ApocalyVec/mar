...
def update_ema(target_params, source_params, rate=0.99):
    ...
    # NOTE
    This smooths out the high-frequency noise in the rapidly changing training weights
    and usually gives a slightly better-behaved model for evaluation or sampling
    (a standard trick in diffusion and GAN literature).
